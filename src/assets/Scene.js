...
function createScene() {
	...
	// Terrain
	var ground = BABYLON.Mesh.CreateGroundFromHeightMap("ground", "map.jpg", 100, 100, 100, 0, 12, scene, true);   
    var groundMaterial = new BABYLON.StandardMaterial("groundMat", scene);
	groundMaterial.diffuseTexture = new BABYLON.Texture("terre.png", scene);
	...
	// Character import
	BABYLON.SceneLoader.ImportMesh("", "./", "him.babylon", scene, function (newMeshes, particleSystems, skeletons)
	{
